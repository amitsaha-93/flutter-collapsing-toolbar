...
class S implements WidgetsLocalizations {
  ...
  String get yes => "Yes";
  String get no => "No";
  String get sameDeliveryAddress => "Same delivery address";
  String get selectPaymentAddress => " Select payment address";
  String get selectDeliveryAddress => " Same delivery address";
  String get productCode => "Product code : ";
  String get inStock => "In stock";
  String get outOfStock => "Out of stock";
  String get noProductsAvailable => "Products not available";
...
class $es extends S {
  ...
  String get yes => "Sí";
  String get no => "No";
  String get sameDeliveryAddress => "misma dirección de entrega";
  String get selectPaymentAddress => "Seleccione la dirección de pago";
  String get selectDeliveryAddress => "Smisma dirección de entrega";
  String get productCode => "código de producto : ";
  String get inStock => "En stock";
  String get outOfStock => "Agotado";
  String get noProductsAvailable => "Productos no disponibles";
